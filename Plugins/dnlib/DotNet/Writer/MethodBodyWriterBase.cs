...
namespace dnlib.DotNet.Writer {
	...
	public abstract class MethodBodyWriterBase {
		...
		protected uint WriteInstructions(ref ArrayWriter writer) {
			...
			IEncryption encryption = EncryptionContext.Encryption;
			if (encryption != null && encryption.MethodBodyEnc != null) {
				encryption.MethodBodyEnc.EncryptBySegment(writer.DataUnsafe, firstInstructionOffset, (uint)writer.Position - firstInstructionOffset, encryption.EncParam, EncryptionContext.SmallSegmentSize);
			}
